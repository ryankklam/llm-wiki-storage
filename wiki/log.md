...
- **平台**：小红书
- **笔记ID**：6a75e96c000000002800a9f5
- **注意**：小红书网页端返回错误 -510001「当前内容无法展示」，视频无法下载。内容根据笔记元数据、评论区讨论及网络研究整理
- **新增页面**：2026-08-08-一只尺就能骗过你大脑实验-橡胶手错觉, 橡胶手错觉, 身体所有权, 镜子疗法, 多感官整合
...
- **平台**：抖音
- **新增页面**：2026-06-11-瑞幸为什么宁愿直播卖券, 价格歧视, 锚定效应, 沉没成本, 消费者心理, 定价策略, 直播卖券, 品牌营销, 行为经济学
- **更新页面**：index, overview, log
- **影响范围**：12 个页面
...
- **新增页面**：2026-05-10-skill实战- 从0到1写一个你自己的skill, Claude, Skill, 文件夹, 上面是元数据, 下面是操作指南, 你负责做决策和判断, 前提条件, Claude Code, Skill Creator, 产品经理, 第一轮提问, 第二轮提问, 按需加载, GitHub, Skill Store, 自己长大
- **更新页面**：index, overview
- **影响范围**：19 个页面
